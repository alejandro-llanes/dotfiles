...
local global_keys = gears.table.join(
	...
	-- Directional focus: Super + Alt + Arrow keys
	--
	...
	end, { description = "Execute default terminal (" .. terminal .. ")", group = "Application" }),
...
local client_keys = awful.util.table.join(
    ...
    if c and screen[2] then
		...
		if screen2.tags[1] then
			...
			screen2.tags[1]:view_only() -- optional
		else
	...
	awful.key({ "Mod4", "Shift" }, "#" .. numpad_key_codes[1], function(c)
		snap_edge(c, "bottom_left")
	end, { description = "Snap client to bottom-left", group = "Client" }),
	awful.key({ "Mod4", "Shift" }, "#" .. numpad_key_codes[2], function(c)
		snap_edge(c, "bottom")
	end, { description = "Snap client to bottom", group = "Client" }),
	awful.key({ "Mod4", "Shift" }, "#" .. numpad_key_codes[3], function(c)
		snap_edge(c, "bottom_right")
	end, { description = "Snap client to bottom-right", group = "Client" }),
	awful.key({ "Mod4", "Shift" }, "#" .. numpad_key_codes[4], function(c)
		snap_edge(c, "left")
	end, { description = "Snap client to left", group = "Client" }),
	awful.key({ "Mod4", "Shift" }, "#" .. numpad_key_codes[5], function(c)
		snap_edge(c, "centered")
	end, { description = "Snap client to center", group = "Client" }),
	awful.key({ "Mod4", "Shift" }, "#" .. numpad_key_codes[6], function(c)
		snap_edge(c, "right")
	end, { description = "Snap client to right", group = "Client" }),
	awful.key({ "Mod4", "Shift" }, "#" .. numpad_key_codes[7], function(c)
		snap_edge(c, "top_left")
	end, { description = "Snap client to top-left", group = "Client" }),
	awful.key({ "Mod4", "Shift" }, "#" .. numpad_key_codes[8], function(c)
		snap_edge(c, "top")
	end, { description = "Snap client to top", group = "Client" }),
	awful.key({ "Mod4", "Shift" }, "#" .. numpad_key_codes[9], function(c)
